...
export function LeftSidebar() {
  ...
  return (
    <aside className="fixed left-0 top-0 z-50 h-screen w-16 border-r border-zinc-800 bg-zinc-950 flex flex-col items-center py-4 gap-4 relative">
      <Link href="/" aria-label="Go to homepage" className="mb-4 p-2 rounded-none border border-zinc-800 bg-zinc-900">
        <Image
          src="/Logo.svg"
          alt="Cision logo"
          width={24}
      ...
      <div className="mt-2">
        <div className="relative">
          ...
          <MenuContainer>
            ...
            <MenuItem icon={<MessagesSquare size={24} strokeWidth={1.5} />} onClick={() => setPersonaOpen(true)} />
            <MenuItem icon={<History size={24} strokeWidth={1.5} />} onClick={() => setPersonaOpen(true)} />
